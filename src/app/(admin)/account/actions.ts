...
class UserAction {
  async create(_sessionUserId: string | null, formData: FormData): Promise<AccountActionResult<FullUser>> {
  ...
  async delete(_sessionUserId: string | null, userId: string): Promise<AccountActionResult<null>> {
    try {
...
// Export as Safe Actions
export const createUserAction = withAuthAction(
  userAction.create.bind(userAction),
  { roles: [AccessRole.Admin] },
);

export const getUsersAction = withAuthAction(
  userAction.getAll.bind(userAction),
  { roles: [AccessRole.Admin] },
);

export const updateUserAction = withAuthAction(
  userAction.update.bind(userAction),
  { roles: [AccessRole.Admin] },
);

export const deleteUserAction = withAuthAction(
  userAction.delete.bind(userAction),
  { roles: [AccessRole.Admin] },
);
